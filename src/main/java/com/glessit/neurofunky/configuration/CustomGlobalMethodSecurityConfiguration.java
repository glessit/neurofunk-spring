 ...
 * {@link } annotation on the subclass.
 *
 * @author Rob Winch
 ...
 */
@Configuration
public class CustomGlobalMethodSecurityConfiguration
        implements ImportAware, SmartInitializingSingleton {
    private static final Log logger = LogFactory
            .getLog(CustomGlobalMethodSecurityConfiguration.class);
    ...
    /**
     * Obtains the attributes from {@link } if this class was
     * imported using the {@link } annotation.
     */
    public final void setImportMetadata(AnnotationMetadata importMetadata) {
        Map<String, Object> annotationAttributes = new HashMap<>();
        annotationAttributes.put("mode", AdviceMode.PROXY);
        annotationAttributes.put("proxyTargetClass", false);
        annotationAttributes.put("prePostEnabled", true);
        annotationAttributes.put("securedEnabled", false);
        annotationAttributes.put("jsr250Enabled", false);
        annotationAttributes.put("order", 2147483647);
